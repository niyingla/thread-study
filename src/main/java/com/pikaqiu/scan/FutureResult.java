...
//
//    private final static ConcurrentHashMap<String, com.apec.netty.utils.SyncResultDto> concurrentHashMap = new ConcurrentHashMap();
//
//    /**
//     * 获取结果
//     *
...
//        instance.add(-TIME_OUT, Calendar.MINUTE);
